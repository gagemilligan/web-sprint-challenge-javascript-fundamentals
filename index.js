...
//it can access the variable internal because it is inside of the same parent function and calls the name of the child function that variable lies in
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowercase = []
    array.map(item => lowercase.push(item.animal_name.toLowerCase()));
    return lowercase
  }
